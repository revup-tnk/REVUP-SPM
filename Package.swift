...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "REVUP",
            url: "https://github.com/revup-tnk/REVUP-iOS-SDK/releases/download/1.1.5/REVUP.zip",
            checksum: "e16a0f0dd537d1470263d4641876808d07ab9cff20a4b0563ee03b435f0e9a84"
        ),
    ]
)
