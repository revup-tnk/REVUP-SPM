...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "REVUP",
            url: "https://github.com/revup-tnk/REVUP-iOS-SDK/releases/download/1.1.4/REVUP.zip",
            checksum: "df71ddf0aefcea4bb67e80c809535f619346551c41e285090f88bb079f10b9bb"
        ),
    ]
)
