...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "REVUP",
            url: "https://github.com/revup-tnk/REVUP-iOS-SDK/releases/download/1.1.6/REVUP.zip",
            checksum: "45223be750dc893a1fe556121bafeed585d9268182332e8e151d86b55c6ba81f"
        ),
    ]
)
